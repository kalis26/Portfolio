        ...
        <div className="flex flex-col gap-6 justify-center items-center">
            ...
            <div className="flex flex-col gap-6 items-center shadow-lg shadow-white/5 border-white/5 border-2 bg-white/5 p-8 rounded-xl w-full md:max-w-screen-md">
                ...
                <div className="flex flex-row gap-4 items-center justify-center">
                    <a href="https://github.com/kalis26" target="blank" className="p-2 cursor-pointer bg-white/15 rounded-full hover:bg-white/30 transition-all duration-300">
                        <svg width="36" height="36" viewBox="0 0 96 98" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.linkedin.com/in/amine-mustapha-rachid/" target="blank" className="p-3 cursor-pointer bg-white/15 rounded-full hover:bg-white/30 transition-all duration-300">
                        <svg width="28" height="28" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.instagram.com/_kalis26/" target="blank" className="p-3 cursor-pointer bg-white/15 rounded-full hover:bg-white/30 transition-all duration-300">
                    ...
                    <a href="mailto:aminera2006@gmail.com" target="blank" className="p-3 cursor-pointer bg-white/15 rounded-full hover:bg-white/30 transition-all duration-300">
