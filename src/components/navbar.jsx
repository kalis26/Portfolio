                    ...
                    <div className={`navbar flex items-center relative bg-black rounded-2xl p-4 font-[Geist-Medium] transition-all duration-500 ease-out ${scrollY > 50 && !showOverlay ? 'border border-white/10 shadow-[0_0_20px_rgba(255,255,255,0.08)]' : 'border border-transparent'}`}>
                        ...
                        <div className='hidden lg:flex flex-1 justify-end items-center space-x-4'>
                            <button className="text-black text-sm px-2 py-2 bg-white rounded-lg transition-all duration-300 hover:bg-[rgb(188,185,185)] flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V9l-7-7z"/><path d="M13 3v6h6"/></svg>
                                Download Resume
                            </button>
                        </div>
                        {!showOverlay && (
                ...
                <div className="bg-black h-screen fixed inset-0 z-40">
                    <div className="flex items-center justify-center h-full pt-16">
                        <div className="flex flex-col items-center space-y-8">
                            <a href="/" className="text-[#ceced3] px-6 py-3 hover:text-[#FFFFFF] transition-all duration-300 text-2xl text-center">Home</a>
                            <a href="/" className="text-[#ceced3] px-6 py-3 hover:text-[#FFFFFF] transition-all duration-300 text-2xl text-center">About</a>
                            <a href="/" className="text-[#ceced3] px-6 py-3 hover:text-[#FFFFFF] transition-all duration-300 text-2xl text-center">Experience</a>
                            <a href="/projects.html" className="text-[#ceced3] px-6 py-3 hover:text-[#FFFFFF] transition-all duration-300 text-2xl text-center">Projects</a>
                            <a href="/contact.html" className="text-[#ceced3] px-6 py-3 hover:text-[#FFFFFF] transition-all duration-300 text-2xl text-center">Contact</a>
                            ...
                            <div className="mt-8">
                                <button className="text-black text-lg px-6 py-3 bg-white rounded-lg transition-all duration-300 hover:bg-[rgb(188,185,185)] flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V9l-7-7z"/><path d="M13 3v6h6"/></svg>
                                    Download Resume
                                </button>
                            </div>
                        </div>
